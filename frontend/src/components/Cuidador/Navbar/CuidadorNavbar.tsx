import { HiArrowRightOnRectangle, HiHome, HiPhoto, HiChartBar } from 'react-icons/hi2'
...
const navItems = [
  { label: 'Dashboard', path: '/cuidador/dashboard', icon: HiHome },
      ...
      <div className="relative flex flex-col gap-6 glass-panel px-6 py-4">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm uppercase tracking-[0.35em] text-white/70">Cuidador</p>
              <h1 className="text-2xl font-semibold tracking-tight">{userName || 'Cuidador Alzheon'}</h1>
          ...
          <div className="flex items-center gap-4">
            {patientName && (
              <div className="glass-card px-4 py-2 rounded-full">
                <p className="text-xs text-white/70">Cuidando a</p>
