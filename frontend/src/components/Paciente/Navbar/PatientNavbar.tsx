import { HiArrowRightOnRectangle, HiCog6Tooth, HiDocumentText, HiHome, HiMicrophone, HiPhoto } from 'react-icons/hi2'
...
const navItems = [
  ...
  { label: 'Documentos', path: '/paciente/documentos', icon: HiDocumentText },
